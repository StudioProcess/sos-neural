module.exports = function ( grunt ) {
	...
	grunt.initConfig( {
		...
		concat: {
			...
			build: {
				src: [ 'js/canvas-to-blob.min.js', 'js/settings.js', 'js/neuron.js', 'js/signal.js', 'js/particlePool.js', 'js/particle.js', 'js/axon.js', 'js/neuralNet.js',
			...
			vendor: {
				src: [ 'js/vendor/underscore.js', 'js/vendor/jquery.min.js', 'js/vendor/Detector.js', 'js/vendor/dat.gui.min.js',
						 ...
						 'js/vendor/perlin.js', 'js/vendor/TrailRenderer.js' ],
